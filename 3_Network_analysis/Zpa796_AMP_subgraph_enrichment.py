...
filtered_data = data[['Structural subgraph', 'AM prediction (AF2/AMAPEC)']].dropna()

# Create a contingency table
contingency_table = pd.crosstab(filtered_data['Structural subgraph'], filtered_data['AM prediction (AF2/AMAPEC)'])
...
Where:
- a = Number of AMPs in the cluster (row.iloc[0])
- b = Number of non-AMPs in the cluster (row.iloc[1])
- c = Total number of AMPs outside the cluster = total_AMPs - a
- d = Total number of non-AMPs outside the cluster = total_non_AMPs - b
'''
